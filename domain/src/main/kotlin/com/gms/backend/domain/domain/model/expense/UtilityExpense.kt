...
class UtilityExpense {
    ...
    lateinit var utilityType: UtilityType

    @Column(name = "utility_type_id", insertable = false, updatable = false)
    var utilityTypeId: UUID? = null
    ...
    @JoinTable(
        name = "utility_expense_objects",
        joinColumns = [JoinColumn(name = "utility_expense_id")],
        inverseJoinColumns = [JoinColumn(name = "object_id")],
    )
    var utilityExpensesObjects = mutableSetOf<ObjectStorage>()
}
